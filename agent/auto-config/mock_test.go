...
func (m *mockServerProvider) FindLocalServer() *metadata.Server {
	ret := m.Called()
...
func (m *mockedConfig) expectInitialTLS(t *testing.T, agentName, datacenter, token string) (*structs.CARoot, *structs.IndexedCARoots, *structs.IssuedCert, []string) {
	...
	return ca, indexedRoots, cert, []string{ca2.RootCert}
}
